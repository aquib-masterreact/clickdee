...
function App() {
  return (
    <>
    <div className="md:flex flex-col flex-wrap sm:flex flex-wrap ">
        <div className="flex flex-wrap">
          <div className="md:w-[50%] text-center bg-red-50 p-10 sm:w-[100%] ">
          ...
          <div className="md:w-[25%] text-center p-10 group/item hover:bg-slate-100 hover:scale-110 sm:w-[100%]">
          ...
          <div className="md:w-[25%] text-center bg-red-50 p-10 group/item hover:bg-slate-100 hover:scale-110 sm:w-[100%]">
